...
Requires: lua52 = %{version}-%{release}
...
%package staticdev
Summary: staticdev components for the lua52 package.
Group: Default
Requires: lua52-dev = %{version}-%{release}

%description staticdev
staticdev components for the lua52 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604609419
